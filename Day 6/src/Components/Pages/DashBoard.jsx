...
const DashBoard=()=>{
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setPaidOrders(prev => Math.min(prev + 100, 1174)); 
            setCustomers(prev => Math.min(prev + 300, 3959)); 
            setTokensSold(prev => Math.min(prev + 1000, 14721)); 
            setTotalSales(prev => Math.min(prev + 10000, 150000)); 
        }, 100);
