...
const Waiter=()=>{
    ...
    const foodItems = [
        ...
        },
        {
            ...
            name: "Mutton Biryani",
            price: 300,
            description: "A fragrant rice dish cooked with spices, meat, and saffron.",
            category: "South Indian",
            type: "Non-Veg",
            time: "30-40 mins"
        },
    ...
    return(
        ...
        <h3 className="logo"><span onClick={()=>nav('/')}>Chef </span>Hub</h3>
         {/* <!--main dashboard--> */}
         <div className="dashboard">
            ...
            <a onClick={() => handleMenuClick("All")} className={activeCategory === "All" ? "setactive" : ""}>All</a>
            <a onClick={() => handleMenuClick("South Indian")} className={activeCategory === "South Indian" ? "setactive" : ""}>South Indian</a>
            <a onClick={() => handleMenuClick("North Indian")} className={activeCategory === "North Indian" ? "setactive" : ""}>North Indian</a>
            <a onClick={() => handleMenuClick("Non-Veg")} className={activeCategory === "Non-Veg" ? "setactive" : ""}>Non-Veg</a>
            <a onClick={() => handleMenuClick("Veg")} className={activeCategory === "Veg" ? "setactive" : ""}>Veg</a>
            {/* <a onClick={() => handleMenuClick("Special Items")} className={activeCategory === "Special Items" ? "setactive" : ""}>Special Items</a> */}
            <a onClick={() => handleMenuClick("Drinks")} className={activeCategory === "Drinks" ? "setactive" : ""}>Drinks</a>
            <a onClick={() => handleMenuClick("AddOn")} className={activeCategory === "AddOn" ? "setactive" : ""}>Extras</a>
            </div>
         ...
         <div className="dashboard-order" id="order">
            ...
            {/* <div className="order-total">
                ...
                {count === 0 ?(
                    <button className="order-checkout" disabled>Proceed Fire</button>
                ):(
                    <>
                    <button className="order-checkout">Proceed Fire</button>
